...
export const siteVisuals: Record<string, SiteVisual> = {
  home: { src: "/assets/i3e/portail-min.webp", alt: "Infraestructura IT de i3e Informática" },
  m365: { src: "/assets/i3e/migracion-min.webp", alt: "Migración a Microsoft 365" },
  products: { src: "/assets/i3e/migracion-sharepoint-min.webp", alt: "Microsoft 365 y SharePoint" },
  solutions: { src: "/assets/i3e/migracion-min.webp", alt: "Soluciones Microsoft 365" },
  cyber: { src: "/assets/i3e/proteccion-2-min.webp", alt: "Protección y ciberseguridad" },
  azure: { src: "/assets/i3e/infraestructura-migracion-min.webp", alt: "Infraestructura Microsoft Azure" },
  infra: { src: "/assets/i3e/instalacion-min.webp", alt: "Instalación de infraestructura IT" },
  compliance: { src: "/assets/i3e/implementacion-iso-min.webp", alt: "Implementación de certificaciones ISO" },
  cases: { src: "/assets/i3e/toyota.webp", alt: "Caso de éxito Toyota Starbaix" },
  company: { src: "/assets/i3e/adm-publica.webp", alt: "Proyecto de tecnología para administración pública" },
  contact: { src: "/assets/i3e/contacto-min.webp", alt: "Contacto con i3e Informática" },
};

export const generatedLandingVisuals = {
  hero: { src: "/assets/i3e/generated/i3e-ecosystem-hero.webp", alt: "Ecosistema digital conectado de i3e" },
  m365: { src: "/assets/i3e/generated/i3e-microsoft-365.webp", alt: "Entorno visual de colaboración segura" },
  cybersecurity: { src: "/assets/i3e/generated/i3e-cybersecurity.webp", alt: "Escudo visual de ciberresiliencia" },
  azure: { src: "/assets/i3e/generated/i3e-cloud-infrastructure.webp", alt: "Infraestructura cloud escalable" },
  infrastructure: { src: "/assets/i3e/generated/i3e-it-infrastructure.webp", alt: "Red de infraestructura IT resiliente" },
  compliance: { src: "/assets/i3e/generated/i3e-compliance.webp", alt: "Gobernanza y control tecnológico" },
} satisfies Record<string, SiteVisual>;

export const partnerLogos: PartnerLogo[] = [
  { src: "/assets/i3e/barracuda_authorized_partner_bn.webp", alt: "Barracuda Authorized Partner", scale: 1.25 },
  { src: "/assets/i3e/cisco_partner_bn.webp", alt: "Cisco Partner", scale: 1.2 },
  { src: "/assets/i3e/hp_gold_partner_bn.webp", alt: "HP Gold Partner", scale: 1.05 },
  { src: "/assets/i3e/paloalto_networks_bn.webp", alt: "Palo Alto Networks", scale: 1.45 },
  { src: "/assets/i3e/intel-partner-gold-1-768x768.webp", alt: "Intel Partner Gold", scale: 2.15 },
  { src: "/assets/i3e/logo-epson-partner-768x768.webp", alt: "Epson IT Partner", scale: 2.5 },
];

export const serviceIcons: SiteVisual[] = [
  { src: "/assets/i3e/arcticons-microsoft-365-2.svg", alt: "Microsoft 365" },
  { src: "/assets/i3e/arcticons-security-2.svg", alt: "Ciberseguridad" },
  { src: "/assets/i3e/arcticons-microsoft-azure-2.svg", alt: "Microsoft Azure" },
  { src: "/assets/i3e/arcticons-serverbox-2.svg", alt: "Infraestructuras IT" },
  { src: "/assets/i3e/cert-2.svg", alt: "Certificaciones" },
];

export const landingCapabilities: Capability[] = [
  {
    src: "/assets/i3e/arcticons-microsoft-365-2.svg",
    alt: "Microsoft 365",
    label: { es: "Microsoft 365", en: "Microsoft 365" },
    href: { es: "/microsoft-365", en: "/en/microsoft-365" },
  },
  {
    src: "/assets/i3e/arcticons-security-2.svg",
    alt: "Ciberseguridad",
    label: { es: "Ciberseguridad", en: "Cybersecurity" },
    href: { es: "/ciberseguridad", en: "/en/cybersecurity" },
  },
  {
    src: "/assets/i3e/arcticons-microsoft-azure-2.svg",
    alt: "Microsoft Azure",
    label: { es: "Microsoft Azure", en: "Microsoft Azure" },
    href: { es: "/microsoft-azure", en: "/en/microsoft-azure" },
  },
  {
    src: "/assets/i3e/arcticons-serverbox-2.svg",
...
export const landingServices: Service[] = [
  {
    ...
    icon: "/assets/i3e/arcticons-microsoft-365-2.svg",
  ...
  {
    src: "/assets/i3e/proteccion-2-min.webp",
    alt: "Protección de infraestructura frente a amenazas digitales",
    icon: "/assets/i3e/arcticons-security-2.svg",
  ...
  {
    src: "/assets/i3e/infraestructura-migracion-min.webp",
    alt: "Infraestructura cloud Microsoft Azure",
    icon: "/assets/i3e/arcticons-microsoft-azure-2.svg",
  ...
  {
    src: "/assets/i3e/instalacion-min.webp",
    alt: "Infraestructura IT y servidores empresariales",
    icon: "/assets/i3e/arcticons-serverbox-2.svg",
  ...
  {
    src: "/assets/i3e/implementacion-iso-min.webp",
    alt: "Cumplimiento y certificaciones de seguridad",
    icon: "/assets/i3e/cert-2.svg",
...
export const landingSolutions: LandingVisual[] = [
  {
    src: "/assets/i3e/empresas-rect.webp",
  ...
  {
    src: "/assets/i3e/pymes-rect.webp",
...
export const landingApproaches: LandingApproach[] = [
  {
    src: "/assets/i3e/approach-consulting-original.jpg",
  ...
  {
    src: "/assets/i3e/approach-implementation-original.jpg",
  ...
  {
    src: "/assets/i3e/approach-managed-original.jpg",
...
export const landingCases: LandingVisual[] = [
  ...
  {
    src: "/assets/i3e/entidad-bancaria.webp",
  ...
  {
    src: "/assets/i3e/adm-publica.webp",
...
export const faviconAsset = "/assets/i3e/favicon-i3e-300x300.webp";
